...
expectType<TestTypeWithOptionalProp>(
  {} as UnwrapPartial<Partial<TestTypeWithOptionalProp>>,
);
expectType<TestTypeWithOptionalProps>(
  {} as UnwrapPartial<Partial<TestTypeWithOptionalProps>>,
);
...
expectType<TestTypeWithPartialProp>(
  {} as UnwrapPartial<Partial<TestTypeWithPartialProp>>,
);
...
expectType<TestTypeWithReadonlyProps>(
  {} as UnwrapPartial<Partial<TestTypeWithReadonlyProps>>,
);
...
expectType<TestTypeWithMethod>(
  {} as UnwrapPartial<Partial<TestTypeWithMethod>>,
);
...
expectType<TestType | AnotherTestType>(
  {} as UnwrapPartial<Partial<TestType> | AnotherTestType>,
);
...
expectType<Record<number, string>>(
  {} as UnwrapPartial<Partial<Record<number, string>>>,
);
expectType<string[]>({} as UnwrapPartial<Partial<string[]>>);
expectType<Array<string | undefined>>(
  {} as UnwrapPartial<Array<string | undefined>>,
);
...
expectType<Record<string, unknown>>(
  {} as UnwrapPartial<Partial<Record<string, unknown>>>,
);
expectType<Record<string, any>>(
  {} as UnwrapPartial<Partial<Record<string, any>>>,
);
