...
expectType<'bcabc' | 'acabc' | 'cbcba' | 'cacba'>(
  {} as Replace<'abcabc' | 'cbacba', 'a' | 'b', ''>,
);
expectType<'bcabc' | 'Abcabc' | 'cbcba' | 'cbAcba'>(
  {} as Replace<'abcabc' | 'cbacba', 'a', '' | 'A'>,
);
expectType<'bcabc' | 'Abcabc' | 'acabc' | 'aAcabc'>(
  {} as Replace<'abcabc', 'a' | 'b', '' | 'A'>,
);
...
expectType<'bcbc' | 'cbcb'>(
  {} as Replace<'abcabc' | 'cbacba', 'a', '', { all: true }>,
);
expectType<'bcbc' | 'acac'>(
  {} as Replace<'abcabc', 'a' | 'b', '', { all: true }>,
);
expectType<'bcbc' | 'AbcAbc'>(
  {} as Replace<'abcabc', 'a', '' | 'A', { all: true }>,
);

expectType<'bcbc' | 'acac' | 'cbcb' | 'caca'>(
  {} as Replace<'abcabc' | 'cbacba', 'a' | 'b', '', { all: true }>,
);
expectType<'bcbc' | 'AbcAbc' | 'cbcb' | 'cbAcbA'>(
  {} as Replace<'abcabc' | 'cbacba', 'a', '' | 'A', { all: true }>,
);
expectType<'bcbc' | 'AbcAbc' | 'acac' | 'aAcaAc'>(
  {} as Replace<'abcabc', 'a' | 'b', '' | 'A', { all: true }>,
);

expectType<
  'bcbc' | 'AbcAbc' | 'acac' | 'aAcaAc' | 'cbcb' | 'cbAcbA' | 'caca' | 'cAacAa'
...
expectType<NineHundredNinetyNineOnes>(
  {} as Replace<NineHundredNinetyNineZeroes, '0', '1', { all: true }>,
);
