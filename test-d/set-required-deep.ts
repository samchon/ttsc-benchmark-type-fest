...
// Preserves readonly
declare const variation10: SetRequiredDeep<
  { a: 1; readonly b: { c?: 1 } },
  'b.c'
>;
expectType<{ a: 1; readonly b: { c: 1 } }>(variation10);

declare const variation11: SetRequiredDeep<
  { readonly a?: 1; readonly b?: { readonly c?: 1 } },
  'a' | 'b'
>;
expectType<{ readonly a: 1; readonly b: { readonly c?: 1 } }>(variation11);

declare const variation12: SetRequiredDeep<
  { readonly a?: 1; readonly b?: { readonly c?: 1 } },
  'a' | 'b' | 'b.c'
>;
...
declare const variation14: SetRequiredDeep<
  { 0?: 1; 1?: { 2?: string } },
  0 | 1
>;
...
// Multiple keys
declare const variation15: SetRequiredDeep<
  { a?: 1; b?: { c?: 2 }; d?: { e?: { f?: 2 }; g?: 3 } },
  'a' | 'b' | 'b.c' | 'd.e.f' | 'd.g'
>;
expectType<{ a: 1; b: { c: 2 }; d?: { e?: { f: 2 }; g: 3 } }>(variation15);

// Index signatures
declare const variation16: SetRequiredDeep<
  { [x: string]: any; a?: number; b?: { c?: number } },
  'a' | 'b.c'
>;
expectType<{ [x: string]: any; a: number; b?: { c: number } }>(variation16);

// Preserves union in nested keys
declare const variation17: SetRequiredDeep<
  { a: 1; b?: { c?: 1 } | number },
  'b'
>;
expectType<{ a: 1; b: { c?: 1 } | number }>(variation17);

declare const variation18: SetRequiredDeep<
  { a?: number; b?: { c?: number } | { d?: string } },
  'b' | 'b.d'
>;
...
declare const variation19: SetRequiredDeep<
  { 1.2?: string; 1?: { 2?: string } },
  1.2
>;
expectType<{ 1.2: string; 1?: { 2?: string } }>(variation19);

declare const variation20: SetRequiredDeep<
  { 1.2?: string; 1?: { 2?: string } },
  '1.2'
>;
expectType<{ 1.2?: string; 1?: { 2: string } }>(variation20);

declare const variation21: SetRequiredDeep<
  { 1.2?: string; 1?: { 2?: string } },
  1.2 | '1.2'
>;
...
// Works with unions
declare const variation22: SetRequiredDeep<
  { a?: { readonly b?: number } } | { readonly b?: { c?: number[] } },
  'a.b' | 'b' | 'b.c'
>;
...
declare const variation23: SetRequiredDeep<
...
declare const variation24: SetRequiredDeep<
  { a?: number; b?: { readonly c?: { 1?: number } } | { d?: { 1?: number } } },
  'a' | `b.${'c' | 'd'}.1`
>;
expectType<{
  a: number;
  b?: { readonly c?: { 1: number } } | { d?: { 1: number } };
}>(variation24);

// Calls `RequiredDeep` when `KeyPaths` is `any`
declare const variation25: SetRequiredDeep<
  { a?: number; readonly b?: { c?: string } },
  any
>;
...
expectType<{ a: readonly [string, number, boolean] }>(
  {} as SetRequiredDeep<
    { a: readonly [string, number?, boolean?] },
    'a.1' | 'a.2'
  >,
);
...
expectType<{ readonly a: [string, number, boolean?, ...number[]] }>(
  {} as SetRequiredDeep<
    { readonly a: [string?, number?, boolean?, ...number[]] },
    'a.0' | 'a.1'
  >,
);
...
expectType<{ readonly a?: [string, number, boolean, ...string[]] }>(
  {} as SetRequiredDeep<
    { readonly a?: [string, number?, boolean?, ...string[]] },
    'a.1' | 'a.2'
  >,
);
...
expectType<{ a: readonly [string, number, boolean, ...string[]] }>(
  {} as SetRequiredDeep<
    { a?: readonly [string, number?, boolean?, ...string[]] },
    'a' | 'a.1' | 'a.2'
  >,
);
...
expectType<{ a?: readonly [string?, number?, boolean?, ...number[]] }>(
  {} as SetRequiredDeep<
    { a?: readonly [string?, number?, boolean?, ...number[]] },
    'a.10'
  >,
);
...
expectType<{ a: [string | undefined, number | undefined, boolean] }>(
  {} as SetRequiredDeep<
    { a: [string | undefined, (number | undefined)?, boolean?] },
    'a.0' | 'a.1' | 'a.2'
  >,
);
expectType<{
  a: readonly [string | undefined, (number | undefined)?, boolean?];
}>(
  {} as SetRequiredDeep<
    { a: readonly [(string | undefined)?, (number | undefined)?, boolean?] },
    'a.0'
...
expectType<{ a: [string, number, boolean?, string?, string?] }>(
  {} as SetRequiredDeep<
    { a: [string?, number?, boolean?, string?, string?] },
    'a.0' | 'a.1' | 'a.3'
  >, // `a.3` can't be required when `a.2` is optional
);
expectType<{
  a: readonly [string | undefined, number?, boolean?, ...string[]];
}>(
  {} as SetRequiredDeep<
    { a?: readonly [string | undefined, number?, boolean?, ...string[]] },
    'a' | 'a.2'
  >, // `a.2` can't be required when `a.1` is optional
);
...
expectType<{ a: string[] }>(
  {} as SetRequiredDeep<{ a: string[] }, `a.${number}`>,
);
expectType<{ readonly a: ReadonlyArray<string | number> }>(
  {} as SetRequiredDeep<
    { readonly a?: ReadonlyArray<string | number> },
    'a' | `a.${number}`
  >,
);
