...
declare const deepInterface: PickDeep<
  DeepInterface,
...
declare const optionalUnion: PickDeep<
  Testing,
  'optionalObject.string' | 'object.number'
>;
expectType<{
...
declare const leadingSpreadArray1: PickDeep<
  Testing,
  `object.leadingSpreadArray.${number}.a`
>;
expectType<{ object: { leadingSpreadArray: [...Array<{ a: 1 }>] } }>(
  leadingSpreadArray1,
);

declare const leadingSpreadArray2: PickDeep<
  Testing,
  `object.leadingSpreadArray.${number}`
>;
expectType<{ object: { leadingSpreadArray: [...Array<{ a: 1 }>, { b: 2 }] } }>(
  leadingSpreadArray2,
);

declare const tailingSpreadArray1: PickDeep<
  Testing,
  'object.tailingSpreadArray.1'
>;
expectType<{
  object: { tailingSpreadArray: [unknown, { b: { c: 2; other: 2 } }] };
}>(tailingSpreadArray1);

declare const tailingSpreadArray2: PickDeep<
  Testing,
  'object.tailingSpreadArray.1.b.c'
>;
