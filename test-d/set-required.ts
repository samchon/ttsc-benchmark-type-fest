...
expectType<[string, number, boolean?]>(
  {} as SetRequired<[string, number?, boolean?], 1>,
);
expectType<[string, number, boolean, ...number[]]>(
  {} as SetRequired<[string, number?, boolean?, ...number[]], '1' | '2'>,
);
expectType<readonly [string, number, boolean]>(
  {} as SetRequired<readonly [string?, number?, boolean?], '0' | 1 | 2>,
);
...
expectType<readonly [string, number, boolean]>(
  {} as SetRequired<readonly [string, number?, boolean?], '1' | '2'>,
);

// Mix of optional and rest elements
expectType<[string, number?, boolean?, ...number[]]>(
  {} as SetRequired<[string?, number?, boolean?, ...number[]], '0'>,
);
expectType<[string, number, boolean, ...number[]]>(
  {} as SetRequired<[string?, number?, boolean?, ...number[]], '0' | '1' | 2>,
);

// Mix of optional, required, and rest elements
expectType<readonly [string, number, boolean?, ...number[]]>(
  {} as SetRequired<readonly [string, number?, boolean?, ...number[]], '1'>,
);
expectType<[string, number, boolean, ...string[]]>(
  {} as SetRequired<[string, number?, boolean?, ...string[]], '1' | 2>,
);
...
expectType<[string, number?, boolean?]>(
  {} as SetRequired<[string, number?, boolean?], '0'>,
);
expectType<readonly [string, number, boolean]>(
  {} as SetRequired<readonly [string, number, boolean], 1 | 2>,
);
expectType<readonly [string, number, boolean, ...number[]]>(
  {} as SetRequired<readonly [string, number, boolean, ...number[]], 1 | 2>,
);
expectType<[string, number, boolean, ...number[]]>(
  {} as SetRequired<[string, number?, boolean?, ...number[]], '0' | '1' | '2'>,
);
...
expectType<[string, number?, boolean?]>(
  {} as SetRequired<[string, number?, boolean?], 10>,
);
expectType<[string, number, boolean]>(
  {} as SetRequired<[string?, number?, boolean?], 0 | 1 | 2 | 3 | 4>,
);
expectType<readonly [string, number, boolean?, ...number[]]>(
  {} as SetRequired<readonly [string, number?, boolean?, ...number[]], 10 | 1>,
);

// Marks all keys as required, if `Keys` is `any`.
expectType<[string, number, boolean]>(
  {} as SetRequired<[string?, number?, boolean?], any>,
);
expectType<[string, number, boolean, ...number[]]>(
  {} as SetRequired<[string, number?, boolean?, ...number[]], any>,
);
expectType<readonly [string, number, boolean, ...number[]]>(
  {} as SetRequired<readonly [string, number, boolean, ...number[]], any>,
);
expectType<readonly [string, number, boolean, ...number[]]>(
  {} as SetRequired<readonly [string, number?, boolean?, ...number[]], any>,
);
...
expectType<[string, number, boolean]>(
  {} as SetRequired<[string?, number?, boolean?], number>,
);
expectType<[string, number, boolean, ...number[]]>(
  {} as SetRequired<[string, number?, boolean?, ...number[]], number>,
);
expectType<readonly [string, number, boolean, ...number[]]>(
  {} as SetRequired<readonly [string, number, boolean, ...number[]], number>,
);
expectType<readonly [string, number, boolean, ...number[]]>(
  {} as SetRequired<readonly [string, number?, boolean?, ...number[]], number>,
);
...
expectType<readonly [string?, number?, ...number[]]>(
  {} as SetRequired<readonly [string?, number?, ...number[]], never>,
);
...
expectType<[...string[], string | undefined, number]>(
  {} as SetRequired<[...string[], string | undefined, number], any>,
);
expectType<[boolean, ...string[], string, number]>(
  {} as SetRequired<[boolean, ...string[], string, number], any>,
);
...
expectType<[x: string, y: number]>(
  {} as SetRequired<[x?: string, y?: number], '0' | '1'>,
);
...
expectType<ReadonlyArray<string | number>>(
  {} as SetRequired<ReadonlyArray<string | number>, number>,
);
