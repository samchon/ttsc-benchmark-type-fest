...
expectType<symbol>(
  {} as CollapseLiterals<typeof sym1 | typeof sym2 | (symbol & {})>,
);
expectType<bigint>({} as CollapseLiterals<1n | 2n | (bigint & {})>);
expectType<`on${string}`>(
  {} as CollapseLiterals<'onChange' | 'onClick' | (`on${string}` & {})>,
);
expectType<'change' | 'click' | `on${string}`>(
...
expectType<null | undefined | string>(
  {} as CollapseLiterals<null | undefined | 'foo' | 'bar' | (string & {})>,
);
expectType<'foo' | Uppercase<string> | number>(
  {} as CollapseLiterals<'foo' | 'BAR' | (Uppercase<string> & {}) | number>,
);
expectType<typeof sym1 | 'foo' | 'bar' | number>(
  {} as CollapseLiterals<typeof sym1 | 'foo' | 'bar' | (number & {})>,
);
...
expectType<string | number | boolean>(
  {} as CollapseLiterals<string | number | boolean>,
);
