...
declare const noOptionsSpecified: ApplyDefaultOptions<
  PathsOptions,
  DefaultPathsOptions,
  {}
>;
...
declare const someOptionsSpecified: ApplyDefaultOptions<
  PathsOptions,
  DefaultPathsOptions,
...
declare const someOptionsSpecified2: ApplyDefaultOptions<
  PathsOptions,
  DefaultPathsOptions,
  { maxRecursionDepth: 5 }
>;
...
declare const allOptionsSpecified: ApplyDefaultOptions<
  PathsOptions,
  DefaultPathsOptions,
  { maxRecursionDepth: 5; bracketNotation: false; leavesOnly: false; depth: 1 }
>;
expectType<{
  maxRecursionDepth: 5;
  bracketNotation: false;
...
declare const requiredOptions: ApplyDefaultOptions<
  { fixedLengthOnly?: boolean; strict: boolean },
...
declare const undefinedsGetOverwritten2: ApplyDefaultOptions<
  { recurseIntoArrays?: boolean | undefined },
  { recurseIntoArrays: true },
  { recurseIntoArrays: undefined }
>;
expectType<{ recurseIntoArrays: undefined }>(undefinedsGetOverwritten2);

declare const undefinedAsValidValue: ApplyDefaultOptions<
  { recurseIntoArrays: boolean | undefined },
  {},
  { recurseIntoArrays: undefined }
>;
...
declare const optionalOptionsGetOverwritten: ApplyDefaultOptions<
  PathsOptions,
  DefaultPathsOptions,
  { maxRecursionDepth?: 5; bracketNotation?: true }
>;
expectType<DefaultPathsOptions>(optionalOptionsGetOverwritten);

declare const anyAsValue: ApplyDefaultOptions<
  { includes?: any },
  { includes: any },
  { includes: string }
>;
...
declare const neverAsOptionsGetOverwritten: ApplyDefaultOptions<
  PathsOptions,
  DefaultPathsOptions,
  never
>;
...
declare const anyAsOptionsGetOverwritten: ApplyDefaultOptions<
  PathsOptions,
  DefaultPathsOptions,
  any
>;
...
type SomeType3<Options extends SomeTypeOptions> = _SomeType3<
