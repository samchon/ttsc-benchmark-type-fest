...
// String is union
// prettier-ignore
expectType<StringSlice<'012' | 'abcd', 0>>(
  {} as '012' | 'abcd',
); // Positive start, no end
// prettier-ignore
expectType<StringSlice<'012' | 'abcd', -2>>(
  {} as '12' | 'cd',
); // Negative start, no end
// prettier-ignore
expectType<StringSlice<'012' | 'abcd', 0, 2>>(
  {} as '01' | 'ab',
); // Positive start, positive end
// prettier-ignore
expectType<StringSlice<'012' | 'abcd', -2, -1>>(
  {} as '1' | 'c',
); // Negative start, negative end
// prettier-ignore
expectType<StringSlice<'012' | 'abcd', -3, 2>>(
  {} as '01' | 'b',
); // Negative start, positive end
// prettier-ignore
expectType<StringSlice<'012' | 'abcd', 1, -1>>(
  {} as '1' | 'bc',
); // Positive start, negative end

// Start is union
// prettier-ignore
expectType<StringSlice<'0123', 1 | -2>>(
  {} as '123' | '23',
); // Positive/Negative start, no end
// prettier-ignore
expectType<StringSlice<'0123', 2 | -3, 3>>(
  {} as '2' | '12',
); // Positive/Negative start, positive end
// prettier-ignore
expectType<StringSlice<'0123', 0 | -2, -1>>(
  {} as '2' | '012',
); // Positive/Negative start, negative end

// End is union
// prettier-ignore
expectType<StringSlice<'0123', 0, 1 | -2>>(
  {} as '0' | '01',
); // Positive start, positive/negative end
// prettier-ignore
expectType<StringSlice<'0123', -2, 2 | -1>>(
  {} as '' | '2',
...
// prettier-ignore
expectType<StringSlice<'012' | 'abcd', 1 | -2, 2>>(
  {} as '1' | 'b' | '',
); // Positive/Negative start, positive end
...
// prettier-ignore
expectType<StringSlice<'012' | 'abcd', 2, 3 | -1>>(
  {} as '2' | '' | 'c',
); // Positive start, positive/negative end
