...
expectType<AllExtend<[1, 2?, 3?, ...number[]], number>>(true);
expectType<AllExtend<[1, 2?, 3?, ...Array<number | undefined>], number>>(
  {} as boolean,
);
expectType<AllExtend<[1?, 2?, 3?, ...string[]], number>>(false);
...
expectType<AllExtend<[x?: number, y?: number, ...rest: number[]], number>>(
  true,
);
...
expectType<NonStrictNeverAllExtend<[never, any, never, any], never>>(
  {} as boolean,
);
