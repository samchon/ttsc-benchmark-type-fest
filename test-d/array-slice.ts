...
expectType<ArraySlice<[1, 2, 3, ...string[]], 0>>([
  1,
  2,
  3,
  ...(null! as string[]),
...
expectType<ArraySlice<[1, 2, 3, ...string[]], 1, 5>>([
  2,
  3,
  null! as string,
  null! as string,
...
expectType<ArraySlice<[1, 2, 3, ...string[], 4, 5]>>([
  1,
  2,
  3,
  ...(null! as string[]),
...
expectType<ArraySlice<[1, 2, 3, ...string[], 4, 5], 1>>([
  2,
  3,
  ...(null! as string[]),
  4,
...
expectType<ArraySlice<[1, 2, 3, ...string[], 4, 5], 3>>([
  ...(null! as string[]),
  4,
  5,
]);
expectType<ArraySlice<[1, 2, 3, ...string[], 4, 5], 10>>([
  ...(null! as string[]),
  4,
  5,
]);
...
// Unions
// Array is union
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], 0>>(
  {} as [0, 1, 2] | ['a', 'b', 'c', 'd'],
); // Positive start, no end
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], -2>>(
  {} as [1, 2] | ['c', 'd'],
); // Negative start, no end
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], 0, 2>>(
  {} as [0, 1] | ['a', 'b'],
); // Positive start, positive end
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], -2, -1>>(
  {} as [1] | ['c'],
); // Negative start, negative end
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], -3, 2>>(
  {} as [0, 1] | ['b'],
); // Negative start, positive end
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], 1, -1>>(
  {} as [1] | ['b', 'c'],
...
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], 1 | -2, 2>>(
  {} as [1] | ['b'] | [],
); // Positive/Negative start, positive end
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], 0 | -2, -1>>(
  {} as [0, 1] | [1] | ['a', 'b', 'c'] | ['c'],
); // Positive/Negative start, negative end

// Array and end are unions
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], 2, 3 | -1>>(
  {} as [2] | [] | ['c'],
); // Positive start, positive/negative end
expectType<ArraySlice<[0, 1, 2] | ['a', 'b', 'c', 'd'], -3, 3 | -2>>(
  {} as [0, 1, 2] | [0] | ['b', 'c'] | ['b'],
); // Negative start, positive/negative end
