...
expectType<IsTuple<[number, string, ...number[]], {fixedLengthOnly: false}>>(
  true,
);
expectType<IsTuple<[number?]>>(true);
expectType<IsTuple<[number?, string?]>>(true);
...
expectType<IsTuple<readonly [number, string, ...number[]], {fixedLengthOnly: false}>>(
  true,
);
expectType<IsTuple<readonly [number?, string?, ...number[]], {fixedLengthOnly: false}>>(
  true,
...
expectType<IsTuple<[number?, string?] | [] | [number, string, ...number[]], {fixedLengthOnly: false}>>(
  true,
);
expectType<IsTuple<[number?, string?] | [] | [number, string, ...number[]]>>(
  {} as boolean,
);
...
expectType<IsTuple<[string, ...number[]] | [number?, string?, ...number[]]>>(
  false,
);
expectType<IsTuple<[string, ...number[]] | [number?, string?, ...number[]], {fixedLengthOnly: false}>>(
  true,
);
...
expectType<IsTuple<[first: string, ...rest: number[]], {fixedLengthOnly: false}>>(
  true,
);
...
expectType<IsTuple<readonly [string, number?, ...boolean[]], {fixedLengthOnly: false}>>(
  true,
);

// Setting `fixedLengthOnly` to `boolean` falls back to it's default value of `true`
expectType<IsTuple<[number, string, ...number[]], {fixedLengthOnly: boolean}>>(
  false,
);
