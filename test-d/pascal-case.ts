...
expectType<
  PascalCase<'foo BAR-Biz_BUZZ', { preserveConsecutiveUppercase: true }>
>('FooBARBizBUZZ');
expectType<
  PascalCase<'foo BAR-Biz_BUZZ', { preserveConsecutiveUppercase: false }>
>('FooBarBizBuzz');
...
expectType<PascalCase<'foo-bar>>baz', { splitOnPunctuation: true }>>(
  'FooBarBaz',
);
expectType<
  PascalCase<
...
expectType<
  PascalCase<'foo-bar::01', { splitOnPunctuation: true; splitOnNumbers: false }>
>('FooBar01');
expectType<
  PascalCase<'foo-bar::01', { splitOnPunctuation: true; splitOnNumbers: true }>
>('FooBar01');
