...
declare const number: AllUnionFields<
...
declare const string: AllUnionFields<
...
declare const boolean: AllUnionFields<
...
declare const regexp: AllUnionFields<
...
declare const symbol: AllUnionFields<
...
declare const undefined_: AllUnionFields<
...
declare const optional: AllUnionFields<
...
declare const propertyWithKeyword: AllUnionFields<
...
declare const map: AllUnionFields<
...
declare const moreUnion: AllUnionFields<
  | TestingType
...
declare const unionWithOptional: AllUnionFields<
...
declare const mixedKeywords: AllUnionFields<
  { readonly a: string; b: number } | { a: string; readonly b: string }
>;
expectType<{
  readonly a: string;
...
declare const mixedKeywords2: AllUnionFields<
