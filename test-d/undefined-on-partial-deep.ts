...
type TestType1 = UndefinedOnPartialDeep<{
  required: string;
  optional?: string;
  optional2?: number;
  optional3?: string;
}>;
expectAssignable<TestType1>({
  required: '',
  optional: undefined,
  optional2: 1,
});
...
type TestType3 = UndefinedOnPartialDeep<{
  requiredWithUndefind: string | undefined;
}>;
...
type ObjectDeepType = UndefinedOnPartialDeep<{
  obj?: { subObj?: { key?: string } };
}>;
...
type ArrayDeepType = UndefinedOnPartialDeep<{
  array?: Array<{ subArray?: string[] }>;
}>;
expectAssignable<ArrayDeepType>({ array: undefined });
expectAssignable<ArrayDeepType>({ array: [{ subArray: undefined }] });
type ObjectListType = UndefinedOnPartialDeep<{
...
type ReadonlyArrayTest = UndefinedOnPartialDeep<{
