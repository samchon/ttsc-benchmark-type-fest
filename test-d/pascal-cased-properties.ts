...
declare const fooBarPunctuatedSplit: PascalCasedProperties<
  FoobarPunctuated,
  { splitOnPunctuation: true }
>;
expectType<{ HelloWorld1: { 'foo::Bar': string } }>(fooBarPunctuatedSplit);

declare const fooBarPunctuatedSplitNumberSplit: PascalCasedProperties<
  FoobarPunctuated,
...
declare const baz: PascalCasedProperties<
