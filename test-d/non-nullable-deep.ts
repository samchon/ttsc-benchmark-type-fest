...
expectType<{0: {1: string}; 2: number}>(
  {} as NonNullableDeep<{0: {1: string | null} | null; 2: number | undefined}>,
);
...
expectType<[foo: string | number, bar: number]>(
  {} as NonNullableDeep<[foo: string | number | null, bar: number | null | undefined]>,
);
...
expectType<[string, number, ...string[], string, number]>(
  {} as NonNullableDeep<[string, number | undefined, ...Array<string | null>, string, number | undefined]>,
);
...
expectType<ReadonlyMap<{a: string}, [{b: number}]>>(
  {} as NonNullableDeep<ReadonlyMap<{a: string | null}, [{b: number | undefined}]>>,
);
expectType<ReadonlySet<{a: string}>>(
  {} as NonNullableDeep<ReadonlySet<{a: string | null}>>,
);
expectType<WeakMap<{a: string}, [{b: number}]>>(
  {} as NonNullableDeep<WeakMap<{a: string | null}, [{b: number | undefined}]>>,
);
...
expectType<Promise<Map<string, {a: number}>>>(
  {} as NonNullableDeep<Promise<Map<string | null, {a: number | undefined} | null>>>,
);
