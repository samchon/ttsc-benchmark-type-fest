...
expectType<string | number | boolean | bigint | symbol>(
  {} as NonNullableDeep<Primitive>,
);
...
expectType<{ date: Date; regex: RegExp }>(
  {} as NonNullableDeep<{ date: Date | null; regex: RegExp | undefined }>,
);
...
expectType<{ a: never; b: never; c: never }>(
  {} as NonNullableDeep<{ a: null; b: undefined; c: null | undefined }>,
);
expectType<[never, never, never, ...never[]]>(
  {} as NonNullableDeep<[null, undefined, null | undefined, ...null[]]>,
);

// Objects
expectType<{ a: string }>({} as NonNullableDeep<{ a: string | null }>);
expectType<{ a: { b: string; c: number } }>(
  {} as NonNullableDeep<{ a: { b: string | null; c: number | undefined } }>,
);
expectType<{ a: { b: string } }>(
  {} as NonNullableDeep<{ a: { b: string | null } | null }>,
);
expectType<{ a: { b: { c: { d: string } } } }>(
  {} as NonNullableDeep<{ a: { b: { c: { d: string | null } } } }>,
);
expectType<{ [x: string]: { a: number } }>(
  {} as NonNullableDeep<{ [x: string]: { a: number | null } | null }>,
);
expectType<{ 0: { 1: string }; 2: number }>(
  {} as NonNullableDeep<{
    0: { 1: string | null } | null;
    2: number | undefined;
  }>,
);
...
expectType<Array<string | number>>(
  {} as NonNullableDeep<Array<string | number | null>>,
);
expectType<[foo: string | number, bar: number]>(
  {} as NonNullableDeep<
    [foo: string | number | null, bar: number | null | undefined]
  >,
);
expectType<[string, number, ...string[]]>(
  {} as NonNullableDeep<[string, number | undefined, ...Array<string | null>]>,
);
expectType<[...string[], string, number]>(
  {} as NonNullableDeep<[...Array<string | null>, string, number | undefined]>,
);
expectType<[string, number, ...string[], string, number]>(
  {} as NonNullableDeep<
    [
      string,
      number | undefined,
...
expectType<Array<Array<{ a: string | [number, { a: string }] }>>>(
  {} as NonNullableDeep<
    Array<
      | undefined
      | Array<{
...
expectType<Map<{ a: string }, [{ b: number }]>>(
  {} as NonNullableDeep<Map<{ a: string | null }, [{ b: number | undefined }]>>,
);
expectType<Set<{ a: string }>>(
  {} as NonNullableDeep<Set<{ a: string | null }>>,
);
expectType<ReadonlyMap<{ a: string }, [{ b: number }]>>(
  {} as NonNullableDeep<
    ReadonlyMap<{ a: string | null }, [{ b: number | undefined }]>
  >,
);
expectType<ReadonlySet<{ a: string }>>(
  {} as NonNullableDeep<ReadonlySet<{ a: string | null }>>,
);
expectType<WeakMap<{ a: string }, [{ b: number }]>>(
  {} as NonNullableDeep<
    WeakMap<{ a: string | null }, [{ b: number | undefined }]>
  >,
);
expectType<WeakSet<{ a: string }>>(
  {} as NonNullableDeep<WeakSet<{ a: string | null }>>,
);
expectType<Promise<{ a: string } | { b: number }>>(
  {} as NonNullableDeep<Promise<{ a: string | null } | { b: number | null }>>,
);
expectType<Promise<Map<string, { a: number }>>>(
  {} as NonNullableDeep<
    Promise<Map<string | null, { a: number | undefined } | null>>
  >,
);

// Preserves `optional` and `readonly` modifiers.
expectType<{ a?: string }>(
  {} as NonNullableDeep<{ a?: string | null | undefined }>,
);
expectType<{ readonly a?: { b?: string | number }; readonly c: number }>(
  {} as NonNullableDeep<{
    readonly a?: { b?: string | number } | null;
    readonly c: number | undefined;
  }>,
);
expectType<ReadonlyArray<{ a: string }>>(
  {} as NonNullableDeep<ReadonlyArray<{ a: string | null }>>,
);
expectType<[string?, number?]>(
  {} as NonNullableDeep<[string?, (number | undefined)?]>,
);
expectType<readonly [string?, ...Array<number | { a: string }>]>(
  {} as NonNullableDeep<
    readonly [string?, ...Array<number | { a: null | string }>]
  >,
);
...
expectType<{ a: [string, number] | { a: { b: string } | { c: string } } }>(
  {} as NonNullableDeep<{
    a:
      | null
      | [string, number | null]
      | { a: { b: string } | { c: string | undefined } | null };
  }>,
);

// Constructors remain unchanged
expectType<new (a: string | null | undefined) => { a: string }>(
  {} as NonNullableDeep<new (a: string | null | undefined) => { a: string }>,
);

// Functions
expectType<() => string>({} as NonNullableDeep<() => string | undefined>);
expectType<(a: string) => void>(
  {} as NonNullableDeep<(a: string | null) => void>,
);
...
expectType<
  (x: [string, { a: string }]) => Map<{ a: string }, Set<{ b: number }>>
>(
  {} as NonNullableDeep<
    (
      x: [string | null, { a: string | undefined }],
    ) => Map<{ a: string | null }, Set<{ b: number | undefined }>>
  >,
);
...
); // `Simplify` removes the call signature from `typeof functionWithProperties`
...
expectType<{ p1: { p2?: string } }>(
  {} as Simplify<typeof functionWithProperties2>,
);
...
expectType<{ p1: string | null }>(
  {} as Simplify<typeof functionWithProperties3>,
);

// `any`, `never`, and `unknown` as nested values
expectType<{ a: { b: any }; c: never; d: unknown }>(
  {} as NonNullableDeep<{ a: { b: any }; c: never; d: unknown }>,
);
