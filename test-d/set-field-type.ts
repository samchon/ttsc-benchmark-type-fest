...
declare const variation2: SetFieldType<
  { a: number; b: boolean; c: Date },
  'a' | 'b',
  string
>;
expectType<{ a: string; b: string; c: Date }>(variation2);

declare const variation3: SetFieldType<
...
declare const variation4: SetFieldType<
...
declare const variation5: SetFieldType<
  { a: string; b: string } | { a: number; c: number },
  'a',
  boolean
>;
expectType<{ a: boolean; b: string } | { a: boolean; c: number }>(variation5);

declare const variation6: SetFieldType<
  { a: string; b: string } | { a: number; c: number },
  'a',
  boolean,
...
declare const variation7: SetFieldType<
  { a?: string; readonly b: string; c: string },
  'c',
  number
>;
expectType<{ a?: string; readonly b: string; c: number }>(variation7);

declare const variation8: SetFieldType<
  { a?: string; readonly b: string; c: string },
  'c',
  number,
  { preservePropertyModifiers: false }
...
declare const variation9: SetFieldType<
  { a?: string; readonly b: string; readonly c?: string },
  'a' | 'c',
  number
>;
...
declare const variation10: SetFieldType<
  { a?: string; readonly b: string; readonly c?: string },
  'a' | 'c',
  number,
  { preservePropertyModifiers: false }
...
declare const variation11: SetFieldType<
  { a?: string; readonly b: string; readonly c?: string },
  'a' | 'c',
  number,
  { preservePropertyModifiers: boolean }
>;
expectType<{ a?: number; readonly b: string; readonly c?: number }>(
  variation11,
);
