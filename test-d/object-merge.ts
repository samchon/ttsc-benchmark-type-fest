...
expectType<{ a: number; b: string }>(
  {} as ObjectMerge<{ a: number }, { b: string }>,
);
expectType<{ a: string }>({} as ObjectMerge<{ a: number }, { a: string }>);
expectType<{ a: string; b: boolean }>(
  {} as ObjectMerge<{ a: number }, { a: string; b: boolean }>,
);
expectType<{ a: string; b: boolean }>(
  {} as ObjectMerge<{ a: number; b: boolean }, { a: string }>,
);
expectType<{ a: string; b: string; c: number }>(
  {} as ObjectMerge<{ a: number; b: string }, { a: string; c: number }>,
);
expectType<{ a: string; b: boolean }>(
  {} as ObjectMerge<{}, { a: string; b: boolean }>,
);
expectType<{ a: string; b: boolean }>(
  {} as ObjectMerge<{ a: string; b: boolean }, {}>,
);
...
expectType<{ [x: string]: number | string; b: number | string; c: string }>(
  {} as ObjectMerge<
    { readonly [x: string]: number; b: number },
    { readonly [x: string]: string; c: string }
  >,
);
// Readonly is not preserved even for non-overlapping keys
expectType<{ a: string; b: number; c: string }>(
  {} as ObjectMerge<
    { a: number; readonly b: number },
    { a: string; readonly c: string }
  >,
);
...
expectType<{
  ...
  {} as ObjectMerge<
    { readonly [x: string]: number; [sym]: string },
    { [x: symbol]: number; a?: string }
  >,
);
expectType<{
  a?: number | string;
...
expectType<{ [x: string]: string | number; a: string | number; b: 1; c: 2 }>(
  {} as ObjectMerge<
    { a: string; b: boolean },
    { [x: string]: number; b: 1; c: 2 }
  >,
);
expectType<{
  [x: `is${string}`]: boolean | 'y' | 'n';
  isLoading: boolean | 'y' | 'n';
  isOpen: boolean | 'y' | 'n';
  foo: string;
  bar: number;
}>(
...
expectType<{
  ...
  {} as ObjectMerge<
    { [x: string]: number; [sym]: boolean; a: 1; b: 2 },
    { [x: string]: string; b: 'b'; c: 'c' }
  >,
);
// Multiple index signatures
expectType<{
  [x: `on${string}`]: string | string[];
  [x: `handle${string}`]: number | number[];
...
expectType<{
  [x: string]: string | boolean | bigint;
  [x: symbol]: number;
  [x: number]: string | boolean;
  [x: `is${string}`]: bigint | string;
}>(
  {} as ObjectMerge<
...
expectType<{
  [x: string]: string | number;
  [x: Lowercase<string>]: string | number;
}>(
  {} as ObjectMerge<
    { [x: string]: string },
    { [x: Lowercase<string>]: number }
  >,
);
...
expectType<{
  [x: Lowercase<string>]: string | number;
  [x: Uppercase<string>]: string | number;
}>(
  {} as ObjectMerge<
    { [x: Lowercase<string>]: number },
...
expectType<{ 0: string; 1: string }>(
  {} as ObjectMerge<{ '0': number }, { 0: string; 1: string }>,
);
expectType<{ '0': string; '1': string }>(
  {} as ObjectMerge<{ 0?: number }, { '0': string; '1': string }>,
);
// String/number key with number/string index signature
expectType<{ [x: string]: number | string; 0: string }>(
  {} as ObjectMerge<{ [x: string]: number }, { 0: string }>,
);
expectType<{ [x: number]: number | string; '0': string }>(
  {} as ObjectMerge<{ [x: number]: number }, { '0': string }>,
);
// Optional number key with string index signature
expectType<{ [x: string]: number | string; 0?: string | number }>(
  {} as ObjectMerge<{ [x: string]: number }, { 0?: string }>,
);
...
expectType<{
  ...
  {} as ObjectMerge<
    { [x: number]: number; [x: symbol]: boolean },
    { '0'?: string }
  >,
);
...
expectType<{ [x: string]: string | number; 0: number | string }>(
  {} as ObjectMerge<{ 0: number }, { [x: string]: string }>,
);
expectType<{
  ...
  {} as ObjectMerge<
    { '0': number },
    { [x: number]: string; [x: symbol]: boolean }
  >,
);
...
expectType<{ [x: string]: number | string; 0: string | number }>(
  {} as ObjectMerge<{ 0: string }, { [x: string]: number }>,
);
expectType<{ [x: number]: number | string; '0': string | number }>(
  {} as ObjectMerge<{ '0': string }, { [x: number]: number }>,
);
// Index signature in `Second` with overwritten key in `First`
expectType<{ [x: string]: number; [x: symbol]: boolean; 0: 1 | 2 | 3 }>(
  {} as ObjectMerge<
    { [x: symbol]: boolean; '0': string },
    { [x: string]: number; 0: 1 | 2 | 3 }
  >,
);
// Index signature in `Second` with non-overwritten key in `First`
expectType<{ [x: string]: number | string; 0: string | 1 | 2 | 3 }>(
  {} as ObjectMerge<{ 0: string }, { [x: string]: number; '0'?: 1 | 2 | 3 }>,
);
...
expectType<{ '0': number | string }>(
  {} as ObjectMerge<{ '0': number }, { 0?: string }>,
);
expectType<{ 0: number | string }>(
  {} as ObjectMerge<{ 0: number }, { '0'?: string }>,
);
...
// === Unions ===
expectType<
  { a: number; b: string; c: number } | { a: number; c: number; d: string }
>(
  {} as ObjectMerge<
...
// === Functions ===
expectType<{ a: string }>(
  {} as ObjectMerge<{ a: string }, (a1: string, a2: number) => void>,
);
expectType<{ a: number }>(
  {} as ObjectMerge<
    { a: string },
    { (a1: string, a2: number): void; a: number }
  >,
);
expectType<{ a: string }>({} as ObjectMerge<() => string, { a: string }>);
expectType<{ a: string }>(
  {} as ObjectMerge<{ (): string; a: number }, { a: string }>,
);
...
expectType<unknown>(
  {} as ObjectMerge<ReadonlyMap<string, number>, { a: string }>,
);
expectType<unknown>(
  {} as ObjectMerge<{ a: string }, ReadonlyMap<string, number>>,
);
