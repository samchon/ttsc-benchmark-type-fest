...
type TestingType = {
  ...
  array2:
    | Array<{ propertyA: string; propertyB: number | undefined }>
    | undefined;
  readonly1: readonly any[] | undefined;
  readonly2:
    | ReadonlyArray<{ propertyA: string; propertyB: number | undefined }>
    | undefined;
  readonly readonlyProperty: string | undefined;
  tuple:
    | ['test1', { propertyA: string; propertyB: number | undefined }]
    | undefined;
};
declare const indexType: {
  [k: string]: string | undefined;
  propertyA: string;
  propertyB: string | undefined;
};
declare const indexTypeUnknown: {
  [k: string]: unknown;
  propertyA: string;
...
declare const indexTypeWithoutRecursion: PartialOnUndefinedDeep<
  typeof indexType
>;
declare const indexTypeUnknownWithoutRecursion: PartialOnUndefinedDeep<
  typeof indexTypeUnknown
>;
expectType<{
  [k: string]: string | undefined;
  propertyA: string;
...
declare const bar: PartialOnUndefinedDeep<
  TestingType,
...
declare const indexTypeWithRecursion: PartialOnUndefinedDeep<
  typeof indexType,
  { recurseIntoArrays: true }
>;
declare const indexTypeUnknownWithRecursion: PartialOnUndefinedDeep<
  typeof indexTypeUnknown,
  { recurseIntoArrays: true }
>;
expectType<{
