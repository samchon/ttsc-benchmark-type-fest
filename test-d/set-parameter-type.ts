...
expectType<
  (a: number, b: boolean, c: Object, ...arguments_: boolean[]) => null
>(test1);
test1(1, true, {}, true);

// Test multiple parameters
declare const test2: SetParameterType<
  typeof function_,
  { 0: string; 2: boolean }
>;
expectType<
  (a: string, b: string, c: boolean, ...arguments_: boolean[]) => null
>(test2);
test2('1', '2', true, true);
...
declare const testargs2: SetParameterType<
  typeof function_,
