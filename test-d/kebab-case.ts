...
const kebabFromNumberInTheMiddleSplitOnNumbers: KebabCase<
  'foo2bar',
  { splitOnNumbers: true }
> = 'foo-2-bar';
expectType<'foo-2-bar'>(kebabFromNumberInTheMiddleSplitOnNumbers);

const kebabFromNumberInTheMiddleSplitOnNumbersEdgeCase: KebabCase<
  'foO2Bar',
  { splitOnNumbers: true }
> = 'fo-o-2-bar';
expectType<'fo-o-2-bar'>(kebabFromNumberInTheMiddleSplitOnNumbersEdgeCase);

const kebabFromNumberInTheMiddleSplitOnNumbersEdgeCase2: KebabCase<
  'foO2bar',
  { splitOnNumbers: true }
> = 'fo-o-2-bar';
expectType<'fo-o-2-bar'>(kebabFromNumberInTheMiddleSplitOnNumbersEdgeCase2);

const kebabFromNumberInTheMiddleNoSplitOnNumbers: KebabCase<'foo2bar'> =
  'foo2bar';
expectType<'foo2bar'>(kebabFromNumberInTheMiddleNoSplitOnNumbers);

const kebabFromNumberInTheMiddleNoSplitOnNumbersEdgeCase: KebabCase<'foo2Bar'> =
  'foo2-bar';
expectType<'foo2-bar'>(kebabFromNumberInTheMiddleNoSplitOnNumbersEdgeCase);

const kebabFromNumberInTheMiddleNoSplitOnNumbersEdgeCase2: KebabCase<'foO2bar'> =
  'fo-o2bar';
expectType<'fo-o2bar'>(kebabFromNumberInTheMiddleNoSplitOnNumbersEdgeCase2);

const kebabFromNumberInTheMiddleNoSplitOnNumbersEdgeCase3: KebabCase<'FOO22Bar'> =
  'foo22-bar';
...
declare const withPunctuationAndSplit: KebabCase<
  'onDialog:close',
...
declare const withPunctuationAndSplit2: KebabCase<
  'foo-bar>>baz',
  { splitOnPunctuation: true }
>;
...
declare const withPunctuationAndSplit3: KebabCase<
  'card::after',
  { splitOnPunctuation: true }
>;
...
declare const withPunctuationAndSplit4: KebabCase<
  'div.card::after',
  { splitOnPunctuation: true }
>;
...
declare const withPunctuationSplitAndNumber: KebabCase<
  'foo-bar::01',
  { splitOnPunctuation: true }
>;
expectType<'foo-bar-01'>(withPunctuationSplitAndNumber);

declare const withPunctuationSplitAndNumberSplit: KebabCase<
  'foo-bar::01',
  { splitOnPunctuation: true; splitOnNumbers: true }
>;
expectType<'foo-bar-01'>(withPunctuationSplitAndNumberSplit);

declare const withPunctuationAndNumberSplit2: KebabCase<
  'foo-bar::01',
  { splitOnNumbers: true }
>;
expectType<'foo-bar::-01'>(withPunctuationAndNumberSplit2);

declare const withPunctuationSplitAndNumberSplit2: KebabCase<
  'foo-bar::01',
