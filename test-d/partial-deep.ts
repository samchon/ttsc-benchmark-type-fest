...
const partialDeepBar: PartialDeep<typeof foo.bar, { recurseIntoArrays: true }> =
  foo.bar;
...
expectAssignable<Map<string | undefined, string | undefined> | undefined>(
  partialDeepFoo.bar!.map,
);
...
expectAssignable<
  ReadonlyMap<string | undefined, string | undefined> | undefined
>(partialDeepFoo.bar!.readonlyMap);
expectAssignable<ReadonlySet<string | undefined> | undefined>(
  partialDeepFoo.bar!.readonlySet,
);
...
expectType<PartialDeep<typeof foo, { recurseIntoArrays: true }>>(
  partialDeepFoo,
);

// Check that `{allowUndefinedInNonTupleArrays: false}` is the default
const partialDeepAllowUndefinedInNonTupleArraysFoo: PartialDeep<
  typeof foo,
  { recurseIntoArrays: true }
> = foo;
expectType<string[] | undefined>(
  partialDeepAllowUndefinedInNonTupleArraysFoo.bar!.array,
);
// Check that `{allowUndefinedInNonTupleArrays: true}` behaves as intended
const partialDeepDoNotAllowUndefinedInNonTupleArraysFoo: PartialDeep<
  typeof foo,
  { recurseIntoArrays: true; allowUndefinedInNonTupleArrays: true }
> = foo;
expectType<Array<string | undefined> | undefined>(
  partialDeepDoNotAllowUndefinedInNonTupleArraysFoo.bar!.array,
);
...
const partialDeepNoRecurseIntoArraysBar: PartialDeep<
  typeof foo.bar,
  { recurseIntoArrays: false }
> = foo.bar;
expectType<typeof partialDeepNoRecurseIntoArraysBar | undefined>(
  partialDeepNoRecurseIntoArraysFoo.bar,
);
expectType<((_: string) => void) | undefined>(
  partialDeepNoRecurseIntoArraysBar.function,
);
...
expectAssignable<Map<string | undefined, string | undefined> | undefined>(
  partialDeepNoRecurseIntoArraysBar.map,
);
expectAssignable<Set<string | undefined> | undefined>(
  partialDeepNoRecurseIntoArraysBar.set,
);
...
expectAssignable<
  ReadonlyMap<string | undefined, string | undefined> | undefined
>(partialDeepNoRecurseIntoArraysBar.readonlyMap);
expectAssignable<ReadonlySet<string | undefined> | undefined>(
  partialDeepNoRecurseIntoArraysBar.readonlySet,
);
expectType<readonly string[] | undefined>(
  partialDeepNoRecurseIntoArraysBar.readonlyArray,
);
expectType<readonly ['foo'] | undefined>(
  partialDeepNoRecurseIntoArraysBar.readonlyTuple,
);
...
declare const functionWithProperties3: PartialDeep<
