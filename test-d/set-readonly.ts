...
declare const variation1: SetReadonly<
...
declare const variation2: SetReadonly<
...
declare const variation3: SetReadonly<
...
declare const variation4: SetReadonly<
  { a: number; readonly b: string; c: boolean },
  'b' | 'c'
>;
expectNotAssignable<{ a: boolean; readonly b: string; readonly c: boolean }>(
  variation4,
);

// Preserves optional modifier.
declare const variation5: SetReadonly<
  { a?: number; readonly b?: string; c?: boolean },
  'b' | 'c'
>;
...
// Works with unions.
declare const variation6: SetReadonly<
  { a?: number; b: number; c: boolean } | { a: string; b?: string; d: boolean },
  'a' | 'b'
>;
expectType<
  | { readonly a?: number; readonly b: number; c: boolean }
  | { readonly a: string; readonly b?: string; d: boolean }
>(variation6);

// Marks all keys as readonly, if `Keys` is `any`.
declare const variation7: SetReadonly<
...
declare const variation8: SetReadonly<
...
declare const variation9: SetReadonly<
  { [k: string]: unknown; a: number; readonly b: string },
  'a' | 'b'
>;
expectType<{ [k: string]: unknown; readonly a: number; readonly b: string }>(
  variation9,
);

// Works with functions containing properties
declare const variation10: SetReadonly<
  { (a1: string, a2: number): boolean; p1: string; readonly p2?: number },
  'p1'
>;
expectType<boolean>(variation10('foo', 1));
expectType<{ readonly p1: string; readonly p2?: number }>(
  {} as Simplify<typeof variation10>,
); // Simplify removes the call signature from `typeof variation10`

declare const variation11: SetReadonly<
  {
...
expectType<{ readonly p1: string; readonly p2?: number; p3: boolean }>(
