...
declare const exampleConditionalKeysWithUndefined: ConditionalKeys<
  Example,
  string | undefined
>;
expectType<'a' | 'c'>(exampleConditionalKeysWithUndefined);

declare const exampleConditionalKeysTargetingNever: ConditionalKeys<
  Example,
  never
>;
...
expectType<'a' | 'c'>(
  {} as ConditionalKeys<
    { readonly a: string; readonly b: number; c: Uppercase<string> },
    string
  >,
);
expectType<never>(
...
expectType<'a' | 'b' | 'c'>(
  {} as ConditionalKeys<
    { a: boolean | number; b: boolean; c: number },
    boolean | number
  >,
);
expectType<'b'>(
  {} as ConditionalKeys<
    { a?: boolean | number; readonly b: boolean | number },
    boolean | number
  >,
);
expectType<'a' | 'b'>(
  {} as ConditionalKeys<
    { a?: boolean | number; readonly b?: boolean; c: bigint | number },
...
expectType<'a' | 'b'>(
  {} as ConditionalKeys<{ a?: never; b?: never }, undefined>,
);
...
expectType<'a' | 'b'>(
  {} as ConditionalKeys<
    { a: string; b: bigint } | { a: number; b: string; c: boolean },
    string | number | bigint
  >,
);
expectType<'a'>(
  {} as ConditionalKeys<
    { a: string } | { a: Lowercase<string>; b: Uppercase<string> },
    string
  >,
);
...
expectType<number | 'a'>(
  {} as ConditionalKeys<
    { [x: Uppercase<string>]: string; [x: number]: number; a: number },
    number
  >,
);
