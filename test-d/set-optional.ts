...
declare const variation1: SetOptional<
...
declare const variation2: SetOptional<
  { a: number; b: string; c: boolean },
  'a' | 'b'
>;
...
declare const variation3: SetOptional<
  { a?: number; b?: string; c?: boolean },
  'a' | 'b' | 'c'
>;
...
declare const variation4: SetOptional<
  { a: number; b?: string; c: boolean },
  'b' | 'c'
>;
...
declare const variation5: SetOptional<
  { readonly a: number; readonly b?: string; c: boolean },
  'b' | 'c'
>;
expectType<{ readonly a: number; readonly b?: string; c?: boolean }>(
  variation5,
);

// Works with unions.
declare const variation6: SetOptional<
...
declare const variation7: SetOptional<
...
declare const variation8: SetOptional<
...
declare const variation9: SetOptional<
...
declare const variation10: SetOptional<
...
declare const variation11: SetOptional<
  {
