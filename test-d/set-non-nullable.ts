...
declare const variation1: SetNonNullable<
  { a: number; b: string | undefined; c: boolean | null },
  'b' | 'c'
>;
...
declare const variation2: SetNonNullable<
  { a: number; b: string | null | undefined },
  'b'
>;
...
declare const variation4: SetNonNullable<
  { a: number; b: string | undefined },
  'b'
>;
...
declare const variation5: SetNonNullable<{
  a: number;
  b: string | undefined;
  c: boolean | null;
}>;
...
const variant6Function = <TProperty extends keyof Variation6Config>(
  ...
  property: TProperty,
): config is SetNonNullable<Variation6Config, TProperty> =>
