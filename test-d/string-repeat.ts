...
expectType<StringRepeat<`abc${string}`, 2>>(
  unknown as `abc${string}abc${string}`,
);
expectType<StringRepeat<Uppercase<string>, 2>>(
  unknown as `${Uppercase<string>}${Uppercase<string>}`,
);

// Union cases
expectType<StringRepeat<'0' | '1', 5>>(unknown as '00000' | '11111');
expectType<StringRepeat<'0', 4 | 5>>(unknown as '0000' | '00000');
expectType<StringRepeat<'0' | '1', 4 | 5>>(
  unknown as '0000' | '00000' | '1111' | '11111',
);
