...
const complexFoo: ComplexSchema = {
  ...
  bar: {
    ...
    array: [
      createComplexOption('readonly'),
      createComplexOption('readonly'),
      createComplexOption('readonly'),
    ],
    tuple: [createComplexOption('readonly')],
    objectArray: [
      { key: createComplexOption('readonly') },
      { key: createComplexOption('readonly') },
      { key: createComplexOption('readonly') },
    ],
...
type FooSchemaWithOptionsNoRecurse = Schema<
  typeof foo,
  FooOption,
...
type FooSchemaWithOptionsRecurse = Schema<
  typeof foo,
  FooOption,
...
expectType<Record<string, number>>(
  {} as Schema<ReadonlyMap<string, string>, Record<string, number>>,
);
expectType<Map<string, number>>({} as Schema<Set<string>, Map<string, number>>);
expectType<readonly number[]>(
  {} as Schema<ReadonlySet<string>, readonly number[]>,
);
expectType<{ fn: unknown }>(
  {} as Schema<(a: number, b: number) => void, { fn: unknown }>,
);
expectType<(a: string, b: string) => void>(
  {} as Schema<(a: number, b: number) => void, (a: string, b: string) => void>,
);
expectType<{ a: string }>(
  {} as Schema<Map<string, number> | Set<number> | Date, { a: string }>,
);

// Objects
expectType<{ a: bigint }>({} as Schema<{ a: number }, bigint>);
expectType<{ a: { b: bigint }; c: bigint }>(
  {} as Schema<{ a: { b: number }; c: string }, bigint>,
);
expectType<{
  a: { b: bigint[] };
  c: {
    d: { e: bigint } | { f: { g: bigint } | bigint };
    h: { i: { j: { k: bigint } } };
  };
}>(
  {} as Schema<
...
expectType<{ readonly a: number }>(
  {} as Schema<{ readonly a: string }, number>,
);
expectType<{ a?: number }>({} as Schema<{ a?: string }, number>);
expectType<{ a?: { readonly b?: number } }>(
  {} as Schema<{ a?: { readonly b?: string } }, number>,
);
expectType<{ 0?: { readonly 1?: number } }>(
  {} as Schema<{ 0?: { readonly 1?: string } }, number>,
);
expectType<{
  readonly a: boolean;
  b?: boolean;
  readonly c?: {
    readonly d?: { e?: boolean } | { readonly f: boolean };
    g: { h: { readonly i: boolean } };
  };
}>(
  {} as Schema<
    {
      ...
      b?: string;
      readonly c?: {
        readonly d?: { e?: number } | { readonly f: number };
        g: { h: { readonly i: bigint } };
      };
    },
    boolean
  >,
...
expectType<{ a?: { b?: string } }>(
  {} as Schema<{ a?: { b?: number } | undefined }, string>,
);
expectType<{ a: { b?: string } | string }>(
  {} as Schema<{ a: { b?: number } | undefined }, string>,
);

// Index signatures
expectType<Record<string, number>>(
  {} as Schema<Record<string, string>, number>,
);
expectType<Record<string, { a: boolean; b: boolean }>>(
  {} as Schema<Record<string, { a: string; b: number }>, boolean>,
);
expectType<Set<number> | Record<string, Set<number>>>(
  {} as Schema<Map<string, string> | Record<string, string>, Set<number>>,
);
expectType<{ [K: string]: number; a: number; b: number }>(
  {} as Schema<{ [K: string]: string; a: string; b: string }, number>,
);
expectType<{ [K: number]: string; 0: string; 1: string }>(
  {} as Schema<{ [K: number]: boolean; 0: boolean; 1: boolean }, string>,
);
...
expectType<{ a: { b: { c: string } } }>(
  {} as Schema<any, { a: { b: { c: string } } }>,
);

// Unions
expectType<{ a: string } | { b: { c: string } }>(
  {} as Schema<{ a: number } | { b: { c: number } }, string>,
);
expectType<{ a: { b: null } | { c: { d: null } } }>(
  {} as Schema<{ a: { b: string } | { c: { d: number } } }, null>,
);
expectType<{ a: { b: null } | null }>(
  {} as Schema<{ a: { b: string } | string }, null>,
);
...
expectType<{ readonly a?: string }>(
  {} as Schema<
    Map<string, string> | Set<string> | Date | RegExp | (() => number),
    { readonly a?: string }
  >,
);
...
expectType<[{ a: bigint }, bigint]>(
  {} as Schema<[{ a: string }, number], bigint>,
);
expectType<[Set<string>, Set<string>?, Set<string>?]>(
  {} as Schema<[string, number?, boolean?], Set<string>>,
);
expectType<[string, { a: string }?, string?]>(
  {} as Schema<[string, { a: number }?, boolean?], string>,
);
expectType<[null | undefined, null | undefined, ...Array<null | undefined>]>(
  {} as Schema<[string, number, ...string[]], null | undefined>,
);
expectType<[{ a?: string }?, { a?: string }?]>(
  {} as Schema<[string?, string?], { a?: string }>,
);
expectType<[bigint, bigint?, { a: { b: bigint } }?, ...bigint[]]>(
  {} as Schema<[string, number?, { a: { b: string } }?, ...string[]], bigint>,
);
expectType<[bigint?, bigint?, ...Array<{ a?: { b: bigint } }>]>(
  {} as Schema<[string?, number?, ...Array<{ a?: { b: string } }>], bigint>,
);
expectType<[...bigint[], bigint, bigint]>(
  {} as Schema<[...string[], string, number], bigint>,
);
expectType<[bigint, ...bigint[], bigint, bigint]>(
  {} as Schema<[string, ...string[], string, number], bigint>,
);
...
expectType<[x: number[], y: number[]]>(
  {} as Schema<[x: bigint, y: bigint], number[]>,
);
expectType<[x: [x1: string, x2: string], y: [y1: string, y2: string]]>(
  {} as Schema<
    [x: [x1: number, x2: number], y: [y1: number, y2: number]],
    string
  >,
);
// Caveat: Optional properties with explicit `undefined` don't behave differently from optional properties without explicit `undefined`.
...
expectType<[{ a: bigint }?]>(
  {} as Schema<[({ a: number } | undefined)?], bigint>,
);
expectType<[{ a: bigint } | bigint]>(
  {} as Schema<[{ a: number } | undefined], bigint>,
);
...
// === recurseIntoArrays: false ===
expectType<string>(
  {} as Schema<number[], string, { recurseIntoArrays: false }>,
);
expectType<number>(
  {} as Schema<[string, string, string], number, { recurseIntoArrays: false }>,
);
expectType<{ a: number; b: number } | number>(
  {} as Schema<
    { a: string[]; b: string } | [string, string, string],
    number,
    { recurseIntoArrays: false }
  >,
);
