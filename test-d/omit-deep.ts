...
declare const omitNotExistProperties: OmitDeep<
  Testing,
  'not_in_Testing' | 'not_in_Testing2'
>;
...
declare const union: OmitDeep<
  DeepType,
  'nested.deep.deeper.value' | 'nested.deep.deeper.value2'
>;
expectType<{
  nested: {
    deep: {
...
/** Test for arrays */
declare const recurseIntoArray: OmitDeep<
  { array: BaseType['objectArray'] },
  `array.${number}.a`
>;
expectType<{ array: Array<{ b: 2 }> }>(recurseIntoArray);

declare const recurseIntoArray2: OmitDeep<
  { array: BaseType['objectArray'] },
  'array.0.a'
>;
expectType<{ array: [{ b: 2 }, ...Array<{ a: 1; b: 2 }>] }>(recurseIntoArray2);

declare const recurseIntoArray3: OmitDeep<
  { array: BaseType['objectArray'] },
  'array.3.a'
>;
expectType<{
...
declare const arrayWithMultiplePaths: OmitDeep<
  { array: Array<{ a: string; b: number; c: string }> },
  `array.${number}.a` | `array.${number}.b`
>;
expectType<{ array: Array<{ c: string }> }>(arrayWithMultiplePaths);

declare const tupleWithMultiplePaths: OmitDeep<
  { tuple: [{ a: string; b: number; c: string }] },
  'tuple.0.a' | 'tuple.0.b'
>;
