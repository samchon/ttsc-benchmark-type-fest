...
expectType<{ a: string; b?: never } | { a?: never; b: number }>(
  {} as ExclusifyUnion<{ a: string } | { b: number }>,
);
expectType<
...
expectType<
  | { a: string; b: number; c?: never; d?: never }
  | { a?: never; b?: never; c: string; d: number }
...
>(
  {} as ExclusifyUnion<
    { a: string } | { b: string; c: number } | { d: 1; e: 2; f: 3 }
  >,
);

// Single member union
expectType<{ a: string }>({} as ExclusifyUnion<{ a: string }>);
expectType<{ a?: string; readonly b?: number }>(
  {} as ExclusifyUnion<{ a?: string; readonly b?: number }>,
);

// Shared keys
expectType<{ a: string; b?: never } | { a: string; b: number }>(
  {} as ExclusifyUnion<{ a: string } | { a: string; b: number }>,
);
expectType<
  | { a: string; b?: never; c?: never }
...
>(
  {} as ExclusifyUnion<
    { a: string } | { a: string; b: number } | { b: string; c: boolean }
  >,
);

// Already exclusive unions
expectType<{ a: string; b?: never } | { a?: never; b: number }>(
  {} as ExclusifyUnion<{ a: string; b?: never } | { a?: never; b: number }>,
);
expectType<{ a: string } | { a: number }>(
  {} as ExclusifyUnion<{ a: string } | { a: number }>,
);

// Preserves property modifiers
expectType<
  | { a?: 1; readonly b: 2; readonly c?: 3; d?: never; e?: never }
  | { a?: never; b?: never; c?: never; d: 4; readonly e?: 5 }
>(
  {} as ExclusifyUnion<
    { a?: 1; readonly b: 2; readonly c?: 3 } | { d: 4; readonly e?: 5 }
  >,
);
expectType<
  { a?: string; readonly b: number } | { readonly a: string; b?: number }
>(
  {} as ExclusifyUnion<
    { a?: string; readonly b: number } | { readonly a: string; b?: number }
  >,
...
expectType<Set<string> | Map<string, string>>(
  {} as ExclusifyUnion<Set<string> | Map<string, string>>,
);
expectType<WeakSet<{ a: string }> | WeakMap<{ a: string }, string>>(
  {} as ExclusifyUnion<WeakSet<{ a: string }> | WeakMap<{ a: string }, string>>,
);
expectType<string[] | Set<string>>(
  {} as ExclusifyUnion<string[] | Set<string>>,
);
...
expectType<{ a: string; b?: never } | { a: number; b: true } | undefined>(
  {} as ExclusifyUnion<{ a: string } | { a: number; b: true } | undefined>,
);
expectType<
  | Date
  | { DDMMYYYY: string; MMDDYYYY?: never }
  | { DDMMYYYY?: never; MMDDYYYY: string }
>({} as ExclusifyUnion<Date | { DDMMYYYY: string } | { MMDDYYYY: string }>);
expectType<
  | RegExp
  | null
  | { foo: string; bar?: never; baz?: never }
  | { foo?: never; bar: number; baz: { qux: string } }
>(
  {} as ExclusifyUnion<
    RegExp | null | { foo: string } | { bar: number; baz: { qux: string } }
  >,
);
