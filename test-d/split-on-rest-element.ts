...
expectType<SplitOnRestElement<readonly ['a', 'b', 'c']>>(
  {} as readonly [['a', 'b', 'c'], [], []],
);
...
expectType<SplitOnRestElement<['a', ...string[], 'b']>>(
  {} as [['a'], string[], ['b']],
);
expectType<SplitOnRestElement<[...boolean[], string]>>(
  {} as [[], boolean[], [string]],
);
expectType<SplitOnRestElement<[...string[], 'x', 'y']>>(
  {} as [[], string[], ['x', 'y']],
);
expectType<SplitOnRestElement<[...never[], 1]>>({} as [[], never[], [1]]);
expectType<SplitOnRestElement<[undefined, ...boolean[], null]>>(
  {} as [[undefined], boolean[], [null]],
);
expectType<SplitOnRestElement<[void, ...never[], 1]>>(
  {} as [[void], never[], [1]],
);
...
// Unions
expectType<SplitOnRestElement<[...Array<string | number>, boolean]>>(
  {} as [[], Array<string | number>, [boolean]],
);
expectType<SplitOnRestElement<[1, 2] | [3, 4]>>(
  {} as [[1, 2], [], []] | [[3, 4], [], []],
);
expectType<SplitOnRestElement<[1, ...number[]] | ['foo', ...string[]]>>(
  {} as [[1], number[], []] | [['foo'], string[], []],
);

// Preserve optional
expectType<SplitOnRestElement<[0, 1?, 2?, ...never[]]>>(
  {} as [[0, 1?, 2?], never[], []],
);
expectType<SplitOnRestElement<[number?, ...string[]]>>(
  {} as [[number?], string[], []],
);
expectType<SplitOnRestElement<[number, boolean?, ...string[]]>>(
...
expectType<SplitOnRestElement<readonly [number] | [string]>>(
...
expectType<SplitOnRestElement<[...FiftyZeroes, ...number[], ...FiftyZeroes]>>(
  {} as [FiftyZeroes, number[], FiftyZeroes],
);
